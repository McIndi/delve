...
**NOTE**: If a log file is rotated (renamed or moved by the system or a log rotation utility), Delve will automatically detect the change and continue monitoring the new file with the same filename.
